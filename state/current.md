...
1. Rock 1 - Leadership Systems: Phase 1 (Map & Define), Jul 1 - Aug 1 - map Jessica's and Shar's recurring responsibilities, draft Leadership Ownership Matrix
2. Rock 2 - 8 Core Operational Processes: finalize remaining 6 1-Pagers and submit all 8 to Dr. Scott for approval by Jul 25
3. Rock 3 - Treatment Acceptance & Financial Coordination: kick off Document + Define phase on Treatment Presentation and Financial Coordination workflows (Jul 1 - 18)
4. Minor Rock - Whale SOP Content Build: awaiting leadership feedback on Jun 26 outlines before starting priority SOP build

## Open Threads

- **Rock 3 scope questions (blocking finalization)** - raised for Dr. Scott/Jessica:
  1. Does the Implementation Standard require full training + live status by Sep 30 for every workflow, or is "published in Whale" acceptable for workflows that don't reach training until late September?
  2. Who leads training per workflow - Stephanie, or do Front Office Supervisors own it as part of their leadership transition?
